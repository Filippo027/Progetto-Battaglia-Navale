public class Griglia {
    ...
    private boolean checkPosizione(int rigaInizio, int colonnaInizio, int rigaFine, int colonnaFine){
    ...
    private boolean checkCoordinateCorrette(int rigaInizio,int colonnaInizio,int rigaFine,int colonnaFine, int naveDaAssegnare){
        ...
        if(!checkPosizione(rigaInizio,colonnaInizio,rigaFine,colonnaFine)){
            return false;
        }
